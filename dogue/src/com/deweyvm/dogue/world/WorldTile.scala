...
object WorldTile {
  val Blank = WorldTile(0 m, 1 atm, Color.Pink, Polar, Point2d.UnitX, 0, 0,  Summer, Tile.Blank)
}

case class WorldTile(height:Meters, pressure:Pressure, region:Color, latitude:LatitudinalRegion, wind:Point2d, daylight:Double, sunTemp:Double, season:Season, tile:Tile) {
