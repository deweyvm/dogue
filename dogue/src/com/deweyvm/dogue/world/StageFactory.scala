  ...
  def create(t:StageType):Stage = {
    ...
    t match {
      ...
      case Chat =>
        ...
        val textOutput = InfoPanel.makeNew(1, 1, cols - 2, rows - 2 - inputHeight - 3, bgColor)//new TextOutput()
      ...
      case World =>
        ...
        val worldPanel = WorldPanel.create(sideWidth + 2, 1, cols - sideWidth - 3, rows - 1 - 1, sideWidth, rows - controlsHeight - 1, bgColor, 4096*16)
